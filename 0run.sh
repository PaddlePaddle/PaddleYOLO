...
# 1. training
#CUDA_VISIBLE_DEVICES=7 python3.7 tools/train.py -c ${config} -r ${weights}
...
#CUDA_VISIBLE_DEVICES=7 python3.7 tools/export_model.py -c ${config} -o weights=${weights}
...
# 6. deploy speed
#CUDA_VISIBLE_DEVICES=7 python3.7 deploy/python/infer.py --model_dir=output_inference/${job_name} --image_file=demo/000000014439_640x640.jpg --device=GPU #--run_benchmark=True --run_mode=trt_fp16
