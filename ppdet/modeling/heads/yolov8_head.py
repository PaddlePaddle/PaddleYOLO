...
class YOLOv8Head(nn.Layer):
    ...
    def forward_train(self, feats, targets):
        ...
        for i, feat in enumerate(feats):
            ...
            reg_list.append(pred_reg.flatten(2).transpose([0, 2, 1]))
    ...
    def forward_eval(self, feats):
        ...
        for i, feat in enumerate(feats):
            ...
            pred_reg = pred_reg.reshape([-1, 4, self.reg_max, l]).transpose(
                [0, 2, 1, 3])
            pred_reg = self.dfl_conv(F.softmax(pred_reg, axis=1))
