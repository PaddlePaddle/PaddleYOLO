...
from ..backbones.efficientrep import make_divisible, SimConv, Transpose, RepLayer, BepC3Layer, BottleRep
...
class CSPRepPAN(nn.Layer):
    ...
    def __init__(self,
        ...
        self.Rep_n3 = BepC3Layer(
            in_ch + out_ch1, out_ch2, num_repeats[2], e=csp_e, block=BottleRep)
