...
class ELANFPN(nn.Layer):
    ...
    ch_settings = {
        ...
        'L': [[512, 256, 128, 256], [256, 128, 64, 128], [128, 256, 128, 256],
              [256, 512, 256, 512]],
        'X': [[640, 256, 256, 320], [320, 128, 128, 160],
              [160, 256, 256, 320], [320, 512, 512, 640]],
    }
    ...
    def forward(self, feats, for_mot=False):
        ...
        p_out1 = paddle.concat([p_out1_down, fpn_out1],
                               1)  # 128*2 + 256 -> 512
        pan_out1 = self.elan_pan1(
            p_out1)  # 512 -> 128*4 + 256*2 -> 1024 -> 256
        # 88
