...
from ..backbones.csp_darknet import BaseConv, DWConv, CSPLayer, C2fLayer
...
class YOLOv8CSPPAN(nn.Layer):
    ...
    1. no lateral conv or downsample conv
    ...
    def forward(self, feats, for_mot=False):
        ...
        pan_out2 = self.fpn_p3(f_concat2)

        # bottom-up PAN
        down_feat1 = self.down_conv2(pan_out2)
